...
<template>
  <div class="flex flex-col gap-6 animate-fade-in text-left">
    ...
    <!-- John's Fundraising Checklist -->
    <div class="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm text-left">
      <h3 class="text-base font-bold text-slate-900 mb-4">John's fundraising checklist</h3>
    ...
    <div class="text-left flex flex-col gap-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div
          class="bg-white border border-slate-100 rounded-3xl overflow-hidden shadow-sm flex flex-col group hover:shadow-md transition-shadow">
          <div class="aspect-video bg-slate-100 relative overflow-hidden">
            <img src="https://images.unsplash.com/photo-1516627145497-ae6968895b74?auto=format&fit=crop&q=80&w=600"
              class="w-full h-full object-cover group-hover:scale-[1.02] transition-transform duration-300" />
          </div>
          <div class="p-5 flex flex-col justify-between flex-grow">
            <h4 class="text-sm font-bold text-slate-900 mb-2 leading-snug">Tips & templates for writing thank you notes
            </h4>
        ...
        <div class="flex flex-col gap-4 justify-between">
          <!-- Sub item 1 -->
          <div
            class="bg-white border border-slate-100 rounded-3xl p-4 flex gap-4 items-center shadow-sm group hover:shadow-md transition-shadow cursor-pointer font-sans">
            <div class="w-20 h-20 rounded-2xl bg-slate-100 overflow-hidden shrink-0">
              <img src="https://images.unsplash.com/photo-1502082553048-f009c37129b9?auto=format&fit=crop&q=80&w=150"
          ...
          <div
            class="bg-white border border-slate-100 rounded-3xl p-4 flex gap-4 items-center shadow-sm group hover:shadow-md transition-shadow cursor-pointer font-sans">
            <div class="w-20 h-20 rounded-2xl bg-slate-100 overflow-hidden shrink-0">
              <img src="https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&q=80&w=150"
                class="w-full h-full object-cover" />
            </div>
            <div class="text-xs">
